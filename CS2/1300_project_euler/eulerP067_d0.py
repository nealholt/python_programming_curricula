...
#Read in the file
file_handle = open('eulerP067_triangle.txt', 'r')
#parse each row into an array of integers
triangle = []
...
#Run the algorithm from problem 18
import eulerP018_d0

eulerP018_d0.solveTriangleSmart(triangle) #Answer 7273. Correct!
