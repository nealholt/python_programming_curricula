...
class Line(Ballistic):
    def __init__(self, screen, x1, y1, x2, y2, dx, dy):
        ...
        super().__init__(screen, (x2+x1)/2, (y2+y1)/2, dx, dy, 0)
...
class Bullet(Ballistic):
    def __init__(self, screen, x, y, angle):
        speed = 10
        super().__init__(screen, x, y, math.cos(angle)*speed, math.sin(angle)*speed, 2)
...
class Ship(Ballistic):
    def __init__(self, screen, x, y):
        super().__init__(screen, x, y, 0, 0, 20)
        self.speed = 0.3
        self.sides = 3
        self.angle = 0
