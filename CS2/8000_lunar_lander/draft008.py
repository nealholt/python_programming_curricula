...
class Ground:
    def __init__(self, surface):
        ...
        self.ground_heights = [[0,0],[200,700],[400,200],[600,550],
                              ...
                              [1600,100],[1650,100],#Landing pad start and end
                              [1800,700],[2000,500],[2200,100]]

    #TODO add an overLandingPad function
    #then check for a collision, while the player is facing upright, and
    #has minimal dx and sufficiently small dy for a safe landing.

    def getHeightAt(self, x): #TODO change this
