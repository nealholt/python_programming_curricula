...
class SplashManager:
    ...
    def update(self, player):
        ...
        if player.y > water_upper_limit-splash_limit and player.y < water_upper_limit+wave_radius:
            ...
            self.splash_list.append(Splash(self.screen, player.x, wave_radius+1, -amount_splash))
            ...
            for i in range(1,splash_spread):
                ...
                self.splash_list.append(Splash(self.screen, player.x+i*splash_width, wave_radius+1, splash_force))
                self.splash_list.append(Splash(self.screen, player.x-i*splash_width, wave_radius+1, splash_force))
