...
Change physics based on conditions: friction, lift when flying close to horizontal.
	DONE-ballistic asteroids controls kept
	DONE-friction is a function of height in atmosphere, zero in space, sharp transition to high friction in water.
	DONE-constant gravity
