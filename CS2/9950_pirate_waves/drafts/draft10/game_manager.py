...
class GameManager:
    def __init__(self):
        ...
        self.sword,self.sword_rect = load_image('images/sword_1.png',-1)
        #Scale down the image
        dimensions = (int(self.sword_rect.width*scaling), int(self.sword_rect.height*scaling))
        self.sword = pygame.transform.scale(self.sword, dimensions)
        self.sword_rect.width = dimensions[0]
        self.sword_rect.height = dimensions[1]
