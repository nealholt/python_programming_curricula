'''
Left and right arrows both shift the boat left and right on the screen, but
also tilt that side down a little bit.
...
while not done:
    ...
    if front_under_water or rear_under_water:
