...
3B. Pass a new random list to each makeTree function.
3C. Use values in the list, (but converted from 0 to 1 to an appropriate range.
...
7. make it so you can click to further evolve a particular tree.
...
#TODO this set of variables will be no more soon.
#seed = 9428
#min_angle_range = 15
#angle_range = 35
...
#depth = 10
#branch_length = 20#80
#length_decrease = 0.8#4
#pensize = 10#50
#thinning = 0.6#3
#thinning_random = 1.2#6
#red = 90
#green = 70
#blue = 30
#d_red1 = 10
...
def makeTree(startx, starty, dna):
    ...
    new_turtle1.color((expressGene(dna,i_red),expressGene(dna,i_green),expressGene(dna,i_blue)))
