...
'''
1 add ball powerup that gives more balls per click
2 disable clicking more while balls are still flying
3 spawn bricks randomly across top of screen
4 when last ball hits bottom of screen, move all bricks down and spawn a new layer with more hp at the top
5 ?
'''
