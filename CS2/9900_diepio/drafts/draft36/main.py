...
10. implement level up system

11. functions for knowing if a particular powerup is still
in effect. then modify the powerup ai to at least go ham while
invincible

11A. Have camera selection skip dead sprites

11B. leaderboard cross out dead names

12. some sort of collision avoidance? or at least alerting of an
obstacle ahead in a particular direction.

13. implement tech tree of specialized units next?
