...
Next step is to display the levels on the screen. And have arrays of levels in
constants. Then experience can be spent for the next level up. Grab numbers
from the java game.
...
import pygame, diep_sprite, player, enemy, funcs, sparkle, powerup
from constants import *
import random #TODO TESTING
...
#print(all_fonts)
testing=powerup.Powerup(screen, 30, 30, white)
all_sprites.append(testing)
while not done:
    #TODO TESTING
    '''randcolor = random.randint(0,255),random.randint(0,255),random.randint(0,255)
    temp = sparkle.Sparkle(screen, critter.x+random.randint(-100,100),
                critter.y+random.randint(-100,100), randcolor)
