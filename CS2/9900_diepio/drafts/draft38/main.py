'''
DONE 11A. Setup machine gunner

DONE 11B. Setup sniper

DONE 11C. Make sure ship.revert and diep_sprite.levelUp work.
They don't currently and there is going to be an issue with: when one powerup expires it resets any other concurrently active powerups. Just note this for now.
Create a new, revertAll function in diep_sprite and revertToBaseline in ship.
revertToBaseline gets set to becomeRammer or whatever. and all of the "become" functions call revertAll.

11D. Make a backup.

11E. ready the project for students with points and assignment.
