'''TODO next steps:
0. Reset dead food (reset and relocate as if it was destroyed and regenerated)
1. Prevent food on food damage.
2. Recoil
3A. Enemy shoots and selects different targets. Basic AI
3B. Vision radius
