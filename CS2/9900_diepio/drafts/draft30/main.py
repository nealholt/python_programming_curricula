...
def makeFood(count,color,shape,radius,all_sprites):
...
makeFood(food_count_circle,green,SHAPE_CIRCLE,food_radius,all_sprites)
makeFood(food_count_rect,yellow,SHAPE_RECT,food_radius,all_sprites)
makeFood(food_count_tri,red,SHAPE_TRI,food_radius,all_sprites)
...
#Make sure everything is sorted. Why isn't everything sorted!?
'''for i in range(10000):
    sortSprites()
'''
#Verify that stuff is sorted
'''for a in all_sprites:
    print(a.x)
pygame.quit(); exit()
'''
