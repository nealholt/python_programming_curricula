...
6.
7.
8. Create type attribute for all sprites and an all_sprites object
9. Implement shooting and health bars
10. Drawing can be more efficient. Only draw things that are on
the screen, for one thing.
11. increase collision efficiency by sorting collision lists.
...
all_critters = [critter, npc_critter]
