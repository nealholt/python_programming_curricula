...
def isBetween(x,left,right):
    '''Returns True if x is greater than or equal to left
...
class LineSeg:
    ...
    def getIntersection(self,other):
        ...
        if m1==None and m2==None:
            #Two vertical lines intersect only if they
        ...
        else: #Lines are neither parallel nor vertical
...
def xMarksSpot(screen,point,color):
    '''Draw an X on the screen at the given point.'''
