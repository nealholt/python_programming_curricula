...
class Car:
    ...
    def getSensorData(self):
        ...
        the neural net or other control mechanism.
        This function returns a list of 7 values. The first 5
        are the percent lengths of the sensors. The next is the
        speed percentage of the car and the last is the angle
        the car is heading. All the values are placed in the
        range 0 to 1. So an angle of 0.5 is 180 degrees.'''
