...
def getAccuracy(predictions, targets):
    ...
    print('Percent correct:'+str((len(targets)-num_not_equal)/row_count))
...
row_count = 400 #Train on this many rows at a time
...
error = network.train(data, targets, iterations=500, learning_rate=0.1)
