...
I've put a lot of effort into optimizing this code. Everything I did
made minimal gains except for this
if self.num_inputs==0 or derror_dout==0:
and this
if self.inputs[i].out != 0:
in the backpropagate function. These cut the time in half.
I strongly advise against spending time attempting further optimization.
'''
import random
