...
0 split this up into many different files for organization

1 Write a depth first and breadth first search AI just to show that you can
...
player3 = AI2(surface, blue, 'SimpleBoi')
