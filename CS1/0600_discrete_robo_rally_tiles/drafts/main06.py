'''
UNTESTED 1 no more than one player per tile
UNTESTED 2 implement shoving
3 Test with motionless bots and keyboard controls. make sure you can force move multiple bots in a row
4 bigger map
...
class Robot:
    ...
    def move(self, board, players):
        print(canMove(board, players, self.row, self.col, self.direction)) #TODO
