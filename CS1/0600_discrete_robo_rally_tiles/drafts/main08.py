...
3
4 parameterize number of blinks and fps and enable a continuous mode that doesn't wait on the space bar
5
6
7
8 add in conveyors
    ...
    if step_forward or play_continuous:
        ...
        if len(action_list) == 0:
            ...
            for p in player_list:
                action_list.append([p, p.chooseAction(board, player_list)])
