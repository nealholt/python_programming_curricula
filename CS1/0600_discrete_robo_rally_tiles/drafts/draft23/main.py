'''
0 Block movement to a tile if the tile has a wall from the other direction.
You can use the functino that the laser uses to detect walls you just
check it from the other direction.
Note, you should use it for the laser too so the laser doesn't pass through walls
...
'''
import math, random, robot, flag, robot_wait, robot_ai1, robot_ai2, robot_greedy
