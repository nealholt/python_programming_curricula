'''
1 Take this code and create a function that returns a
pair for how to change row and column given a direction
this will be handy for the conveyor QoL functions:
    def forceMove(self, players, direction, flags):
        ...
        if direction == 0: #north
            ...
            temp_col -= 1
See where else you can reuse this function (probably in
move?)
After that, handle the #TODO in conveysTo
2
