...
1
2
3 Write a self.turnTowardDirection(direction) function for the robot
4
5 write a basic AI (see the TODO)
6
7
...
class AI1(Robot):
    ...
    move a robot. All non-conveyor tiles return 0,0,0.
        ...
        if self.oscillate:
            ...
            flag = flags[0].color
            for f in flags:
                if f.color in self.flags:
                    flag = f.color
            #TODO LEFT OFF HERE AI Draft 1
...
player1 = Waitbot(surface, 0, 0, white)
player2 = AI1(surface, 4, 3, yellow)
player3 = Robot(surface, 4, 4, red) #Random bot
player4 = Robot(surface, 4, 5, red) #Random bot
