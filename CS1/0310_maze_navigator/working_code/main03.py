...
'''TODO
	Save new draft now.
	MazeRunner does not need put into the maze 2d array. Or if it is put in, don't draw it twice. and don't draw the start.
	Write left hand on wall algorithm. Keep random separate.
	Write the navigation in the wide open. and maze to go with it.
