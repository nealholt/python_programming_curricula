...
class Bird:
	...
	def draw(self):
		...
		#TODO
		#Change the following code. Call self.screen.blit using self.image1
		#if self.image1_on is true. Call self.screen.blit using self.image2
		#if self.image1_on is false.
